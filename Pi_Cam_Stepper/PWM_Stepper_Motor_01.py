...
durationFwd = 1600 # This is the duration of the motor spinning. used for forward direction
durationBwd = 1600 # This is the duration of the motor spinning. used for reverse direction
...
def reverse():
    ...
    print('Controller PUL being driven.')
    #
    while stepper.exe_complete_flag==0:
        stepper.DRVA(durationBwd,delay)
    GPIO.output(ENA, GPIO.LOW)
    print('ENA set to LOW - Controller Disabled')
    sleep(.5) # pause for possible change direction
    return
